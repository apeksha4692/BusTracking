 <div class="col-sm-7 m-auto">
             <div class="border p-3 bg-white">
               <div class="chaperone-add">
                ...
                <form action="<?php echo site_url('subadmin/trip/update_child_parents');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                    <div class="row">
                        ...
                        <input type="hidden" name="trip_add_parents_id" value="<?php echo $trip_add_parents->trip_add_parents_id; ?>">
                         <div class="col-sm-12 ">
                              <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                       ...
                                       <select class="form-control" data-live-search="true" name="child_id" id="child_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_parents'); ?>" onchange="getParentName(this.value);">
                                        <option value="">Select Client</option>
                                        <?php foreach ($getAllChild as $key) { ?>
                                            <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $trip_add_parents->child_id ? 'selected' : '' ?>><?php echo $key['child_name']; ?></option>
                                         <?php } ?>
                                    </select>
                                     </div>
                                </div>  
                             ...
                             <div class="form-group">
                                <div class="row align-items-center">
                                     <label class="col-sm-3"><?php echo $this->lang->line('parents_name'); ?></label>
                                     <div class="col-sm-9">
                                         <input class="form-control" type="text" name="parents_name"  placeholder="<?php echo $this->lang->line('parents_name'); ?>" value="<?php echo $trip_add_parents->parents_name; ?>">
