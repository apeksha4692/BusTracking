...
<div class="login">
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <h4><?php echo $this->lang->line('school_admin_potal'); ?> </h4>
                <form class="login-form" action="<?php echo site_url('subadmin/check_login');?>" method="POST" data-parsley-validate>

                    <div class="row">
                        <div class="col-sm-8">
                      <div class="form-group">
                         <input placeholder="<?php echo $this->lang->line('admin_user_name'); ?>" class="form-control" type="text" name="login_username" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_name'); ?>" value="<?php if (get_cookie('login_username')) { echo get_cookie('login_username'); } ?>">
                         
                         <input placeholder="<?php echo $this->lang->line('admin_user_password'); ?>" class="form-control" type="password" name="login_password" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_password'); ?>" value="<?php if (get_cookie('login_password')) { echo get_cookie('login_password'); } ?>">
                      </div> 
                    </div>
                    <div class="col-sm-3 d-flex align-items-end">
                      <div class="mb-2">
                        <label class="justify-content-center align-items-center d-flex">
                           
                            Remember Me 
                            <!--<input class="ml-2" type="checkbox" name="">-->
                             <input class="ml-2" type="checkbox" name="chkremember" value="Remember me" <?php if (get_cookie('login_username')) { ?> checked="checked" <?php } ?>>
                        </label>
                      </div>
                    </div>  
                    </div> 
                    <div class="row"> 
                    <div class="flex-row-reverse d-flex col-sm-8">
                        <div class="">  
                          <button class="btn-login"><?php echo $this->lang->line('sign_in'); ?></button> 


                          <p class="small text-center mt-2">
                            <a href="<?php echo base_url().'subadmin/forgot_password'?>" >
                              <?php echo $this->lang->line('forgot_password'); ?>
                            </a>
                          </p>

                          <!-- <p class="small text-center mt-2"><?php echo $this->lang->line('forgot_password'); ?></p> -->
                        </div>
                    </div> 
                  </div>
                </form> 
    ...
    <div class="copyright text-center ">
     ...
     <ul class="nav d-flex justify-content-center">
      <li class="nav-item"> <a href="<?php echo site_url('subadmin/about_us');?>" class="nav-link"><?php echo $this->lang->line('about_us'); ?> </a></li>
       <li class="nav-item"> <a href="<?php echo site_url('subadmin/contactUs');?>" class="nav-link"><?php echo $this->lang->line('contact_us'); ?></a> </li>
     </ul>  
