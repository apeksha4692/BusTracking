 <div class="col-sm-12">
               ...
               <div class="">
                <div class="row">
                    <!-- <h4><?= $title?> (<? if(empty($parents_count->parents_total)){ echo 0; }else{ echo $parents_count->parents_total;}?>)</h4> -->
                     ...
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('parents_name'); ?></p> <p class="mb-1"> <?= $parentsDetail->parents_name; ?></p></div>
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('parent_number'); ?></p> <p class="mb-1"> <?= $parentsDetail->phone_number; ?></p></div>
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('secret_code'); ?></p> <p class="mb-1"> <?= $parentsDetail->secret_code; ?></p></div>
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('note'); ?></p> <p class="mb-1"> <?= $parentsDetail->note; ?></p></div>
                 </div>
                    <div class="d-flex mt-3">
                         ...
                         <div class="ml-auto">
                              ...
                              <!--</a>-->
                              <a class="my-btn" href="
                                <?php echo base_url().'subadmin/add_child/'.$parentsDetail->id;?>"> 
                                Add New Child
                      ...
                      <div class="col-sm-12 px-0"> 
                            ...
                            <table class="table table-borderless border-top border-bottom" id="example">
                                <thead>
                                  <tr>
                                    <th scope="col">
                                       <input id="checkbox1" type="checkbox" name="childId[]" class="form-control-custom" onchange="checkAllChild(this)">
                                    </th>
                                ...
                                ?>
                                  <tr>
                                    <th scope="row">
                                      ...
                                      <input id="<?=$value['child_id']?>" type="checkbox" value="<?=$value['child_id']?>" name="child_id[]" class="form-control-custom"  data-id ="<?=$value['child_id']?>" data-parsley-required="true" data-parsley-trigger="click"  onclick="checkBox();">
                                      <label for="<?=$value['child_id']?>"></label><br>
                                      <span id="errmsg" style="color: red;"></span>
                                    </th>
                                     <td><?=$value['child_name']?></td>
                                     <td><img widhth="50px" height="50px" src="<?php echo base_url().'uploads/child_image/'.$value['child_image']; ?> "></td>
        ...
        <div class="modal-dialog">
            <form method="post" action="<?php echo site_url('subadmin/parent/delete_child');?>" enctype="multipart/form-data" data-parsley-validate>
                <input type="hidden" name="child_id" id="txtTripParent" >
                <input type="hidden" name="parents_id" value="<?= $parentsDetail->id;?>">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        
                        <div class="modal-header">
                            <h5 class="modal-title"> 
                                <?php echo $this->lang->line('delete_child'); ?></h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        </div>
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p><?= $this->lang->line('are_you_sure_want_delete_child');?> </p>
                        <!-- </div> -->
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url() ?>subadmin/parent/editChild" enctype="multipart/form-data" data-parsley-validate>
                <input type="hidden" name="child_id" id="txtEdit" >
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p><?php echo $this->lang->line('are_sure_edit_selected_child'); ?> </p>
                        <!-- </div> -->
                        </div>
                        <div class="modal-footer">
                            <button class="my-btn" type="submit" ><?php echo $this->lang->line('yes'); ?> </button>
            ...
            <!-- <form method="post" action="" data-parsley-validate> -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p><?php echo $this->lang->line('sorry_you_select_atleast_child'); ?> </p>
                        <!-- </div> -->
                        </div>
                        <div class="modal-footer">
                            <!-- <button class="my-btn" type="submit" id="modelAlteastBus"><?php echo $this->lang->line('yes'); ?> </button> -->
                            <a href="<?php echo base_url().'subadmin/parents_view/'.$parentsDetail->id;?>" class="my-btn"><?php echo $this->lang->line('ok'); ?></a>
 ...
 <div class="modal fade" id="selectOnlyOneTripModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <!-- <form method="post" action="" data-parsley-validate> -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                            <p><?php echo $this->lang->line('sorry_slect_only_one_child'); ?> </p>
                        </div>
                        <div class="modal-footer">
                            <a href="<?php echo base_url().'subadmin/parents_view/'.$parentsDetail->id;?>" class="my-btn"><?php echo $this->lang->line('ok'); ?></a>
  ...
  <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url() ?>subadmin/parent/exportChildCSV" enctype="multipart/form-data" data-parsley-validate>
                <input type="hidden" name="child_id" id="txtExport" >
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p><?php echo $this->lang->line('are_sure_export_selected_child'); ?> </p>
                        <!-- </div> -->
                        </div>
                        <div class="modal-footer">
...
//Delete Button Function
  function checkAllChild(ele) {
    $('input[name ="child_id[]"]').each( function() {
        if (ele.checked) {
  ...
  $("#btnDelete").click(function(){
      var selected_id = new Array();
      $('input[name="child_id[]"]:checked').each(function() {
     ...
     function checkValue()
    {
        ...
        var counting = $('#counting').val();
        // for(var i=0 ; i<counting)
        $.each($("input[name='child_id[]']:checked"), function(){            
            selected_id.push($(this).val());
        });
        if(selected_id.length == 0)
        {
...
//Export Button Funtion
  ...
  $(document).ready(function(){
      $("#submitExcel").click(function(){        
          ...
          setTimeout(function() {
            window.location = "<?php echo base_url(); ?>/subadmin/parents_view/<?= $parentsDetail->id; ?>";
          }, 2000);
      });
