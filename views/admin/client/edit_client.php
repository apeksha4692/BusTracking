<div class="col-sm-7 m-auto">
    <div class="border p-3 bg-white">
        <div class="chaperone-add">
            ...
            <form action="<?php echo site_url('admin/client/update');?>" enctype="multipart/form-data" method="post" data-parsley-validate="">
                <input type="hidden" name="id" id="client_id" value="<?php echo $getclientData->id;?>"> 
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-9">
                                     <input class="form-control" type="text" placeholder="<?php echo $this->lang->line('client_name'); ?>" name="client_name" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_client_name'); ?> " value="<?php echo $getclientData->client_name; ?>" >
                                </div>
                            </div>  
                        </div>
                        <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-9">
                                     <input class="form-control" type="text" placeholder="<?php echo $this->lang->line('focal_point_name'); ?>" name="focal_point_name" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_focal_point_name'); ?> "  value="<?php echo $getclientData->focal_point_name; ?>">
                                 </div>
                            </div>  
                         </div>
                         <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-9">
                                     <input class="form-control" type="text" placeholder="<?php echo $this->lang->line('focal_point_number'); ?>" id="focal_point_number" name="focal_point_number" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_focal_point_number'); ?>" data-parsley-type="number" data-parsley-required-message="<?php echo $this->lang->line('number_only'); ?>"  min="1" value="<?php echo $getclientData->focal_point_number; ?>" onKeyUp="check_Usernumber(this.value)">
                        ...
                        <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-9">
                                     <input class="form-control" id="focal_point_email" type="text" placeholder="<?php echo $this->lang->line('focal_point_email'); ?>" name="focal_point_email" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_focal_point_email'); ?>" type="email"data-parsley-type="email"  value="<?php echo $getclientData->focal_point_email; ?>" onKeyUp="check_Useremail(this.value)">
                            ...
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-5 text-center">
                                    ...
                                    <div class="upload-btn-wrapper">
                                      ...
                                      <!--<input type='file' name="profile_pic" id="imgadd" class="btn-outline-warning btn btn-sm"/>-->
