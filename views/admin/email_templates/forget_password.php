    ...
    <tbody>
      ...
      <tr>
        <td style="font-family: sans-serif; width: 100%; padding: 0 2rem; color: #000; font-size: 16PX; text-align: left;">
          ...
          <p>
            <a href="<?=base_url();?>auth/admin_reset_verify?token=<?=$id?>" style="padding: 10px 15px;background: #f8ab3b;color: #fff;border-radius: 50px;width: 50%;margin: 40px auto;text-align: center;text-decoration: none;display: block;"><?php echo $this->lang->line('reset_password'); ?></a>
          </p>
