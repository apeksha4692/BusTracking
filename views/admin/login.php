...
<div class="login">
    <div class="container">
        <div class="row">
            <!-- <div class="col-sm-5"> -->
            <div class="col-sm-8">
                <h4><?php echo $this->lang->line('admin_potal'); ?> </h4>
                <form class="login-form" action="<?php echo site_url('admin/check_login');?>" method="POST" data-parsley-validate>
                <div class="row">
                  <div class="col-sm-8">
                    <div class="form-group">
                       <input placeholder="<?php echo $this->lang->line('admin_user_name'); ?>" class="form-control" type="text" name="username" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_name'); ?>" value="<?php if (get_cookie('username')) { echo get_cookie('username'); } ?>">
                       <input placeholder="<?php echo $this->lang->line('admin_user_password'); ?>" class="form-control" type="password" name="password" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_password'); ?>" value="<?php if (get_cookie('password')) { echo get_cookie('password'); } ?>">
                    </div> 
                  </div>
                      ...
                      <div class="mb-2">
                        <label class="justify-content-center align-items-center d-flex">
                            ...
                            <!--<input class="ml-2" type="checkbox" name="">-->
                             <input class="ml-2" type="checkbox" name="chkremember" value="Remember me" <?php if (get_cookie('username')) { ?> checked="checked" <?php } ?>>
                        </label>
                      </div>
                    </div> 
                </div>
    ...
    <div class="copyright text-center ">
     ...
     <ul class="nav d-flex justify-content-center">
       <!-- <li class="nav-item"> <a href="" class="nav-link"><?php echo $this->lang->line('about_us'); ?> About</a></li>
       <li class="nav-item"> <a href="" class="nav-link"><?php echo $this->lang->line(''); ?> Contact</a> </li> -->
     </ul>  
