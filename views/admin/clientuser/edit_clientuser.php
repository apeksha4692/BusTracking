    ...
    <div class="border p-3 bg-white">
        <div class="chaperone-add">
            ...
            <form class="" action="<?php echo site_url('admin/clientuser_update');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                 <input type="hidden" name="id" id="client_user_id" value="<?php echo $getclientUserData->client_user_id?>">
                <div class="row">
                    <div class="col-sm-12 ">
                                ...
                                <div class="col-sm-9">
                                     <select class="form-control" data-live-search="true" name="client_id" id="client_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_client'); ?>">
                                        ...
                                        <?php foreach ($getAllClient as $key) { ?>
                                            <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $getclientUserData->client_id ? 'selected' : '' ?>><?php echo $key['client_name']; ?></option>
                                         <?php } ?>
                                    </select>
                                    </div>
                            </div>  
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-9">
                                     <input class="form-control" id="email" type="text" placeholder="<?php echo $this->lang->line('client_email_id'); ?>" name="email" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_email_id'); ?>" type="email" data-parsley-type="email"  value="<?php echo $getclientUserData->email?>" onKeyUp="check_UserMail(this.value);">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-9">
                                     <input class="form-control" id="login_username" type="text" placeholder="<?php echo $this->lang->line('login_user_name'); ?>" name="login_username" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_login_user_name'); ?>" value="<?php echo $getclientUserData->login_username?>" readonly>
                        ...
                        <div class="form-group">
                            <div class="row align-items-center">
                                 ...
                                 <div class="col-sm-5">
                                     <input class="form-control" id="login_password" type="text" placeholder="Login Password" name="login_password" value="<?php echo $getclientUserData->login_password?>" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_login_password'); ?>">
                                 </div>
...
//Check login User name available
    ...
    {
        var clientUser_id = $('#client_user_id').val();
