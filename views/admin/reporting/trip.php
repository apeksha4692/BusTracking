...
<div class="col-sm-12">
                              ...
                              <div class="row">
                                   <div class="col-sm-12 ">                   <div class="form-group">
                                          <div class="row align-items-center">
                                              <label class="col-sm-4">Find By Trip Id</label>
                                               <div class="col-sm-8">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?= base_url() ?>admin/reporting/trip_list" class="my-btn bg-transparent"><?php echo $this->lang->line('ok'); ?></a>
      ...
      <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url() ?>admin/reporting/TripController/exportTrack" enctype="multipart/form-data" data-parsley-validate>
    ...
    <div class="modal fade" id="pdfModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url() ?>admin/reporting/TripController/pdfTrack" enctype="multipart/form-data" data-parsley-validate>
...
function getBus()
{
  ...
  var buildSearchData =     
        ...
        table = $('#example').DataTable({ 
            "ajax"          :  {
               "url"        : '<?php echo site_url("admin/reporting/TripController/getTripReport"); ?>',
               "type"       : 'POST',
  ...
  function getClient(client_id)
    {
      // alert(client_id);die;
       ...
       var buildSearchData =     
        ...
        table = $('#example').DataTable({ 
            "ajax"          :  {
               "url"        : '<?php echo site_url("admin/reporting/TripController/getTripReportByClient"); ?>',
               "type"       : 'POST',
               "data"       : buildSearchData
           },
            "bDestroy": true 
...
//Export Button Funtion
  ...
  $(document).ready(function(){
      $("#submitExcel").click(function(){        
          setTimeout(function() {
            window.location = "<?php echo site_url('admin/reporting/trip_list');?>";
          }, 2000);
      });
