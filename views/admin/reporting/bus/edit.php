         ...
         <div class="col-sm-7 m-auto">
             <div class="border p-3 bg-white">
               <div class="chaperone-add">
                ...
                <form action="<?php echo site_url('admin/reporting/busUpdate');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                    <input type="hidden" name="bus_id" value="<?= $busDetail->bus_id;?>">
                    <div class="row">
                         <div class="col-sm-12 ">
                                         ...
                                         <select class="form-control" data-live-search="true" name="client_id" id="client_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_client'); ?>" onchange="getClientUser(this.value);">
                                            <option value="">Select Client</option>
                                             <?php foreach ($getAllClient as $key) { ?>
                                                <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $busDetail->client_id ? 'selected' : '' ?>><?php echo $key['client_name']; ?></option>
                                             <?php } ?>
                                        </select>
                                    </div>
                                </div>  
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                         <select class="form-control" data-live-search="true" name="client_user_id" id="client_user_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_client'); ?>" onchange="getClientUserBus(this.value);">
                                            ...
                                            <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $busDetail->client_user_id ? 'selected' : '' ?>><?php echo $key['username']; ?></option>
                                         <?php } ?>
                                        </select>
                                    </div>
                                </div>  
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                        <input class="form-control" type="text" id="bus_number"  placeholder="<?php echo $this->lang->line('bus_number'); ?>"name="bus_number" required data-parsley-required-message="<?php echo $this->lang->line('enter_bus_number'); ?>" readonly value="<?= $busDetail->bus_number; ?>">
                             ...
                             <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                        <input class="form-control" type="text" id="bus_plate_number"  placeholder="<?php echo $this->lang->line('bus_plate_number'); ?>"name="bus_plate_number" required data-parsley-required-message="<?php echo $this->lang->line('enter_bus_plate_number'); ?>" value="<?= $busDetail->bus_plate_number; ?>" readonly>
                             ...
                             <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                         <!-- <input class="form-control"  type="text" id="bus_note" placeholder="<?php echo $this->lang->line('note'); ?>" name="bus_note" required data-parsley-required-message="<?php echo $this->lang->line('enter_note'); ?>" value="<?= $busDetail->bus_note; ?>"> -->

                                         <input class="form-control"  type="text" id="bus_note" placeholder="<?php echo $this->lang->line('note'); ?>" name="bus_note" value="<?= $busDetail->bus_note; ?>">
