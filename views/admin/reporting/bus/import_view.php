<div class="col-sm-7 m-auto" id="import">
 ...
 <div class="modal fade" id="confirmationDownload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/BusController/donwload_bus_import" data-parsley-validate>
     ...
     <div class="modal fade" id="duplicateData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/BusController/replaceDuplicateData" data-parsley-validate>
                <input type="hidden" name="busId" id="txtEdit" >
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?=base_url ()?>admin/reporting/bus_list" class="my-btn"><?php echo $this->lang->line('no'); ?></a>
                            <!-- <button class="my-btn bg-transparent" type="button" data-dismiss="modal"><?php echo $this->lang->line('no'); ?> </button> -->
                        </div>
                    </div>
                </div>
...
$( function() {
    ...
    $("#my-form").on('submit', function (e) { // if submit form
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>admin/reporting/import_bus",
            method:"POST",
