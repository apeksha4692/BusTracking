        ...
        <div class="">
            <div class="filter-menu mb-3">
                ...
                <?php if(in_array("16", $checked_arr)) { ?>
                 ...
                 <?php } if(in_array("17", $checked_arr)) { ?>
                  <li class="nav-item">
                      <a class="<?= $reporting_status;?>" href="<?php echo site_url('admin/reporting/status_list');?>"><?php echo $this->lang->line('trip'); ?></a>
                  </li> 
            ...
            <div class="d-flex w-100">
                <div class="mt-4 mr-auto">
                    <h5><?= $title; ?> (<?= $bus_count->total; ?>)</h5>
                 </div>
                <div class="ml-auto">
                    <?php if(in_array("28", $checked_arr)) {?>
                     ...
                     <?php } if(in_array("29", $checked_arr)) {?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">
                                ...
                                <input id="<?=$value['bus_id']?>" type="checkbox" value="<?=$value['bus_id']?>" name="bus_id[]" class="form-control-custom"  data-id ="<?=$value['bus_id']?>" data-parsley-required="true" data-parsley-trigger="click" onclick="checkBox();">
                                <label for="<?=$value['bus_id']?>"></label><br>
                            ...
                            <td>
                                ...
                                <p class="show-read-more mb-0"><?=$value['bus_note']?></p>
                                <!--<?=$value['bus_note']?>-->
                            ...
                            <!-- <td>
                               <a  title="<?php echo $this->lang->line('edit')?> " href="<?php echo base_url().'admin/reporting/busEdit/'.$value['bus_id'];?>" class="text-warning mr-3" ><?php echo $this->lang->line('edit')?></a>
                             
                               <a  title="<?php echo $this->lang->line('delete'); ?>" class="text-warning mr-3" href="<?php echo base_url().'admin/reporting/BusController/delete/'.$value['bus_id'];?>" onclick="return deleteBus()" ><?php echo $this->lang->line('delete'); ?></a>
                            </td> -->
                        </tr>
                        <?php $i++; } }?>
...
<div class="modal fade" id="deleteAllModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?php echo site_url('admin/reporting/delete_bus');?>" enctype="multipart/form-data" data-parsley-validate>
 ...
 <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form method="post" action="<?= base_url() ?>admin/reporting/BusController/excelBusList" enctype="multipart/form-data" data-parsley-validate>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?= base_url() ?>admin/reporting/BusController/editBus" enctype="multipart/form-data" data-parsley-validate>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?= base_url() ?>admin/reporting/bus_list" class="my-btn bg-transparent"><?php echo $this->lang->line('ok'); ?></a>
...
$( document ).ready(function() {
   ...
   function deleteBus(){
        var result = confirm("<?= $this->lang->line('are_sure_delete');?> <?= $this->lang->line('this_bus');?>");
        if(result == true){
            return true;
        } 
        else{
      ...
      // alert(client_id);die;
       ...
       var buildSearchData =     
        ...
        table = $('#example').DataTable({ 
            "ajax"          :  {
               "url"        : '<?php echo site_url("admin/reporting/BusController/getBusReport"); ?>',
               "type"       : 'POST',
      ...
      $("#submitExcel").click(function(){    
        ...
        //      $('#exportModal').modal('toggle');
          ...
          setTimeout(function() {
            ...
            window.location = "<?php echo site_url('admin/reporting/bus_list');?>";
          }, 2000);
      });
