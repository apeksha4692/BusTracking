...
<div class="modal fade" id="confirmationDownload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/DriverController/donwload_driver_import" data-parsley-validate>
...
<div class="modal fade" id="duplicateData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/DriverController/replaceDriverDuplicateData" data-parsley-validate>
                <input type="hidden" name="busId" id="txtEdit" >
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body" style="text-align: center;">
                          ...
                          <input type="hidden" name="driverNote" id="driverNote">
                        ...
                        <div class="modal-footer">
                            <button class="my-btn bg-transparent" type="submit" id="submitDownload"><?php echo $this->lang->line('yes'); ?> </button>
                            <a href="<?=base_url ()?>admin/reporting/driver_list" class="my-btn"><?php echo $this->lang->line('no'); ?></a>
                            <!-- <button class="my-btn bg-transparent" type="button" data-dismiss="modal"><?php echo $this->lang->line('no'); ?> </button> -->
                        </div>
                    </div>
                </div>
...
$( function() {
    ...
    $("#my-form").on('submit', function (e) { // if submit form
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>admin/reporting/import_driver",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                else
                {
                    ...
                    $("#clientUserId").val(obj.clientUserId);
                    $("#driverName").val(obj.driverName);
                    $("#driverMobile").val(obj.driverMobile);
                    $("#driverNote").val(obj.driverNote);
                }
                // location.reload();
            }
        })
