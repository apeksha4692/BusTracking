<div class="col-sm-7 m-auto">
 ...
 <div class="modal fade" id="confirmationDownload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/ParentsController/donwload_parents_import" data-parsley-validate>
       ...
       <div class="modal fade" id="duplicateData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/ParentsController/replaceParentsDuplicateData" data-parsley-validate>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?=base_url ()?>admin/reporting/parents_list" class="my-btn"><?php echo $this->lang->line('no'); ?></a>
                        </div>
                    </div>
                </div>
            </form>
...
//------------------Import (Choose and select)-------------------
  $( function() {
    ...
    $("#my-form").on('submit', function (e) { // if submit form
        ...
        $.ajax({
             url:"<?php echo base_url(); ?>admin/reporting/import_parents",
            method:"POST",
