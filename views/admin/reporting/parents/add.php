<div class="col-sm-7 m-auto">
             <div class="border p-3 bg-white">
               <div class="chaperone-add">
                ...
                <form action="<?php echo site_url('admin/reporting/parents_insert');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                    <div class="row">
                         <div class="col-sm-12 ">
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-5">
                                         <input class="form-control" id="secret_code" type="text" placeholder="<?php echo $this->lang->line('secret_code'); ?>" name="secret_code" value="<?php if(!empty($post['secret_code'])){echo $post['secret_code'];}else{"";}?>">
                                     </div>
