         ...
         <div class="col-sm-7 m-auto">
             <div class="border p-3 bg-white">
               <div class="chaperone-add">
                ...
                <form action="<?php echo site_url('admin/reporting/chaperoneUpdate');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                    <input type="hidden" name="chaperone_id" value="<?= $chaperoneDetail->chaperone_id;?>">
                    <div class="row">
                         <div class="col-sm-12 ">
                                         ...
                                         <select class="form-control" data-live-search="true" name="client_id" id="client_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_client'); ?>" onchange="getClientUser(this.value);">
                                            <option value="">Select Client</option>
                                             <?php foreach ($getAllClient as $key) { ?>
                                                <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $chaperoneDetail->client_id ? 'selected' : '' ?>><?php echo $key['client_name']; ?></option>
                                             <?php } ?>
                                        </select>
                                    </div>
                                </div>  
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                         <select class="form-control" data-live-search="true" name="client_user_id" id="client_user_id" data-parsley-required="true" data-parsley-required-message="<?php echo $this->lang->line('select_client'); ?>" onchange="getClientUserBus(this.value);">
                                            ...
                                            <option data-tokens="<?php echo $key['id']; ?>" value="<?php echo $key['id']; ?>" <?php echo $key['id'] == $chaperoneDetail->client_user_id ? 'selected' : '' ?>><?php echo $key['username']; ?></option>
                                         <?php } ?>
                                        </select>
                                    </div>
                                </div>  
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-5">
                                         <input class="form-control" id="secret_code" type="text" placeholder="<?php echo $this->lang->line('secret_code'); ?>" name="secret_code" data-parsley-required-message="<?php echo $this->lang->line('secret_code'); ?>" value= "<?= $chaperoneDetail->secret_code;?>" >
                                     </div>
