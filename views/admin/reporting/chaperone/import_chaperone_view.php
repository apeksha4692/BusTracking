<div class="col-sm-7 m-auto">
 ...
 <div class="modal fade" id="confirmationDownload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/ChaperoneController/donwload_chaperone_import" data-parsley-validate>
     ...
     <div class="modal fade" id="duplicateData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=base_url ()?>admin/reporting/ChaperoneController/replaceChaperoneDuplicateData" data-parsley-validate>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?=base_url ()?>admin/reporting/chaperone_list" class="my-btn"><?php echo $this->lang->line('no'); ?></a>
                        </div>
                    </div>
                </div>
            </form>
...
$( function() {
    ...
    $("#my-form").on('submit', function (e) { // if submit form
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>admin/reporting/import_chaperone",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                {
                    toastr.error("Please fill maxmium chaperone and maxium parents");
                    window.location = "<?php echo site_url('admin/reporting/chaperone_list');?>";
