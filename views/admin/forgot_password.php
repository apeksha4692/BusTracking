...
<nav class="navbar navbar-expand-lg navbar-blue bg-white">
  ...
  <a class="navbar-brand mt-3" href="#"><img width="300" src="<?php echo base_url(); ?>assest/img/logo.png"></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-5">
                ...
                <form class="login-form" action="<?php echo site_url('admin/send_mail');?>" method="POST" data-parsley-validate>
