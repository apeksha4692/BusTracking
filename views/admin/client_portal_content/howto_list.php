    ...
    <div class="border p-3 bg-white">
        <div class="">
            <div class="filter-menu mb-3">
               ...
               <div class="row">
                    <div class="col-sm-12"> 
                    <h4 class="mb-3"> English Title : 
                        <p class="show-read-more mb-0"><?php 
                                   echo html_entity_decode($how_to->title); 
                                  ?></p>
                    </h4>
                    </div>
                    
                    <div class="col-sm-12"> 
                        <h4 class="mb-3"> English Description : 
                        <style>
                                ...
                                <p class="show-read-more mb-0"><?php 
                                   echo html_entity_decode($how_to->description); 
                                  ?></p>
                        </h4>
                    </div>
                     
                    <div class="col-sm-12"> <h4 class="mb-3"> Arabic Title : 
                        <p class="show-read-more mb-0"><?php 
                                   echo html_entity_decode($how_to->ar_title); 
                                  ?></p>
                    </h4></div>
                    <div class="col-sm-12"> 
                    <h4 class="mb-3"> Arabic Description : <p class="show-read-more mb-0"><?php 
                                   echo html_entity_decode($how_to->ar_description); 
                                  ?></p>
                    </h4>
                    </div>
                 </div>
            <div class="d-flex w-100">
                ...
                <div class="ml-auto">
                    ...
                    <a class="my-btn mr-3" href="<?php echo base_url().'admin/client_portal_content/editHow_To/'.$how_to->id;?>">
                        Edit How To
                      <!--<i class="fa fa-plus ml-2" aria-hidden="true"></i>-->
                    </a>
                    
                    <a class="my-btn" href="<?php echo site_url('admin/client_portal_content/addHow_To_Img');?>"> 
                      <?php echo $this->lang->line('add_new'); ?> How To Image
                      <i class="fa fa-plus ml-2" aria-hidden="true"></i>
                    </a>
                </div>
            ...
            <div class="">        
                <table class="table table-borderless border-top border-bottom" id="example">
                    <thead>
                        <tr>
                            <th scope="col">
                              <input id="checkbox1" type="checkbox" name="howImg[]" class="form-control-custom" onchange="checkAllImage(this)">
                            </th>
                            <th scope="col">Image
                              <span>
                            ...
                            <th scope="col">English Description
                              <span>
                                            <img class="arrowUp" height="49" width="18" src="<?php echo base_url().'assest/img/down-arrow.svg';?>" style="display: none;">
                                             <img class="arrowDown" height="49" width="18" src="<?php echo base_url().'assest/img/up-arrow.svg';?>" >
                                        </span>
                             </th>
                            <th scope="col">Arabic Description 
                            <span>
                                <img class="arrowUp" height="49" width="18" src="<?php echo base_url().'assest/img/down-arrow.svg';?>" style="display: none;">
                                 <img class="arrowDown" height="49" width="18" src="<?php echo base_url().'assest/img/up-arrow.svg';?>" >
                            </span>
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                            if(!empty($getHowToImg)){
                                foreach ($getHowToImg as $key => $value) { 
                        ?>

                        <tr>
                            <th scope="row">
                                      <!-- <input type="checkbox" name=""> -->
                                <input id="<?=$value['id']?>" type="checkbox" value="<?=$value['id']?>" name="howImg_id[]" class="form-control-custom"  data-id ="<?=$value['id']?>" data-parsley-required="true" data-parsley-trigger="click" onclick="checkBox();">
                                <label for="<?=$value['id']?>"></label><br>
                                <span id="errmsg" style="color: red;"></span>
                            </th>
                            <td> <img widhth="50px" height="50px" src="<?php echo  HOW_TO_IMG.$value['img'];?>"></td>
                            <td>
                                <style>
                                    .show-read-more .more-text{
                                        display: none;
        ...
        <div class="modal-dialog">
            <form method="post" action="<?php echo site_url('admin/client_portal_content/delete_howToImg');?>" enctype="multipart/form-data" data-parsley-validate>
                <input type="hidden" name="howToImgId" id="txtDelete" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p>Are you sure want to delet selected how to image? </p>
                        <!-- </div> -->
                        </div>
            ...
            <!-- <form method="post" action="" data-parsley-validate> -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                         <!-- <div class="form-group"> -->
                            <p>Sorry, you select atleast one how to image. </p>
                        <!-- </div> -->
                        </div>
                        <div class="modal-footer">
                            <a href="<?= base_url() ?>admin/client_portal_content/how_to" class="my-btn bg-transparent"><?php echo $this->lang->line('ok'); ?></a>
            ...
            <!-- <form method="post" action="" data-parsley-validate> -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center;">
                            <p>Sorry, you select only one how to image. </p>
                        </div>
                        <div class="modal-footer">
                            <a href="<?= base_url() ?>admin/client_portal_content/how_to" class="my-btn bg-transparent"><?php echo $this->lang->line('ok'); ?></a>
                            <button class="my-btn bg-transparent" type="button" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?> </button>
...
<script type="text/javascript">
  ...
  function checkAllImage(ele) {
    $('input[name ="howImg_id[]"]').each( function() {
        if (ele.checked) {
