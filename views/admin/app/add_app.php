 <div class="col-sm-7 m-auto">
    <div class="border p-3 bg-white">
        <div class="chaperone-add">
            ...
            <form action="<?php echo site_url('admin/app_insert');?>" enctype="multipart/form-data" method="post" data-parsley-validate="" name="myform">
                <div class="row">
                    <div class="col-sm-12 ">
                         <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                        <input class="form-control" type="text" id="app_version"  placeholder="<?php echo $this->lang->line('app_version'); ?>"name="app_version" required data-parsley-required-message="<?php echo $this->lang->line('enter_app_version'); ?>">
                             ...
                             <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                        <!-- <input class="form-control" type="text" id="release_date"  placeholder="<?php echo $this->lang->line('release_date'); ?>"name="release_date" required data-parsley-required-message="<?php echo $this->lang->line('enter_release_date'); ?>"> -->
                                        <input class="form-control" type="text"  id="release_date"  placeholder="<?php echo $this->lang->line('release_date'); ?>"name="release_date" required data-parsley-required-message="<?php echo $this->lang->line('enter_release_date'); ?>">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="row align-items-center">
                                     ...
                                     <div class="col-sm-9">
                                         <input class="form-control"  type="text" id="notes" placeholder="<?php echo $this->lang->line('note'); ?>" name="notes">
