<?php
    ...
    {	
        ...
        $data['getAllStatus'] = $this->CommonModel->statusDataReport();
        ...
        //     "client_user_id"    =>  ""
        // );
        //  $data['getAllTrip'] = $this->CommonModel->selectResultDataByCondition($whe,'trip');

        // print_r($data['getAllStatus']);die;
    	$this->loadAdminView('admin/reporting/status',$data); 
    }
...
// print_r($arr);die;
    ...
    public function getStatusReportByClient()
    {
        // echo "string";die;
        $client_id = $this->input->post('client_id');
